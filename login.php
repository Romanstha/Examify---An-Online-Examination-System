...
<body>
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0 " style="height:10vh; letter-spacing:0.5px;">
    ...
    <section>
        <div class="container-fluid">
            <div class="container-log" style="margin-top: 60px;">
                ...
                <div class="login-pill mb-4">
                    <ul class="nav nav-pills nav-justified" id="ex1" role="tablist">
                        ...
                        <li class="nav-item">
                            <a style="width: 15rem" class="nav-link" id="tab-admin" role="tab" aria-selected="false">Lecturers/Teacher</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <form id="std_login_form" action="" method="POST">
                                ...
                                <div class="text-center text-lg-start mt-4 pt-2">
                                    ...
                                    <p style='font-size: .875em;' class='fw-700 mt-2 pt-1 mb-0'>
                                        Don't have an account? <strong style="color:red;"> Ask to add first..</strong>
                                        <!-- <a href='student-registration.php' class='link-danger'>Register</a> -->
                                    </p>
                                </div>
                            </form>
                        </div>
